...
//0xd05690b47dC2D1e1743e40FbE7b615AFEE2a2cD6
contract DeployMoodNFT is Script {
    ...
    function run() external returns (MoodNFT) {
        ...
        vm.startBroadcast();
        MoodNFT moodNFT = new MoodNFT(svgToImage(happySvg), svgToImage(sadSvg));
        vm.stopBroadcast();
        return moodNFT;
    }
    ...
    function svgToImage(string memory svg) public pure returns (string memory) {
        ...
        return string(abi.encodePacked(imageUriPrefix, svgBase64Encoded));
    }
}
